The files in this directory are meant to be used as a base for Inferus base config. If you want to build a custom kernel with features, all options in infernus-custom.cfg enabled.
